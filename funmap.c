...
static struct funmap functnames[] = {
	...
	{llm, "llm", 0},
	{llm_set_key, "llm-set-key", 1},
	{llm_set_model, "llm-set-model", 1},
	{llm_set_url, "llm-set-url", 1},
	{evalfile, "load", 1},
	...
	{shell_interrupt, "shell-interrupt", 0},
	{shell_send_eof, "shell-send-eof", 0},
	{shell_send_input, "shell-send-input", 0},
